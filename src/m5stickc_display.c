...
esp_err_t M5StickCDisplayOff()
{
    ...
    e = M5StickCPowerRegisterClearBits(DCDC1_DCDC3_LDO2_LDO3_SWITCH_CONTROL_REG, BIT2);
    if(e == ESP_OK) {
...
esp_err_t M5StickCDisplayOn()
{
    ...
    e = M5StickCPowerRegisterSetBits(DCDC1_DCDC3_LDO2_LDO3_SWITCH_CONTROL_REG, BIT2);
    if(e == ESP_OK) {
